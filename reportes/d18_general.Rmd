...
# Caracterización Socio-demográfica Distrito 18
...
##### Data del censo
d_census = read.csv("https://raw.githubusercontent.com/maibennett/Distrito18/main/data/censo/Cantidad-de-Personas-por-Sexo-y-Edad_d18.csv?token=AFJAWROULO4VI6DO3BEWWMK7RS22K")
...
d_census$edad = factor(d_census$edad)

##### Data del servel
d_inscritos = read.csv()

ggplot(d, aes(x = edad, y = total), fill="white") +
  stat_summary(fun=sum, geom = "bar",col="#F89441",lwd=1.5,fill=alpha("#F89441",0.5))+
...
d = read.csv("https://raw.githubusercontent.com/maibennett/presentations/main/sds_20201016/sim_ppt.csv")
