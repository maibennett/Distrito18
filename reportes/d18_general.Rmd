...
d_votantes2017 = read.csv("https://raw.githubusercontent.com/maibennett/Distrito18/main/data/servel/votantes2017.csv")
...
izq_extra = c("Amplitud","Andha Chile","Comunista De Chile","Ecologista Verde",
              "Humanista","Igualdad","Izquierda Ciudadana De Chile",
              "Mas-Region","Pais","Poder Ciudadano","Progresista","Regionalista Independiente",
              "Revolucion Democratica","Todos","Democracia Regional Patagonica")
...
centro_derecha = c("Renovacion Nacional","Evolucion Politica")
...
ggplot(d_partidos2017_sum, aes(x = partido_6, y = n, color = partido_6, fill=partido_6), 
  ...
  theme_bw()+
  theme_ipsum_fsc(plot_title_face = "bold") + #plain 
  xlab("Edad (años)") + ylab("Num. inscritos/votantes")+ggtitle("Inscritos y votantes por tendencia de partido - D18")+
  theme(plot.margin=unit(c(1,1,1.5,1.2),"cm"),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        panel.grid.major.y = element_blank(),
...
```
---
# Distribución de partidos políticos: Solo insrcritos
