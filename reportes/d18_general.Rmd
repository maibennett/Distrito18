...
m <- leaflet(D18) %>%
  ...
  addPolygons(color = "#444444", weight = 2, smoothFactor = 0.5,
    ...
    direction = "auto"))
   # ) %>%
  #  addMarkers(lng=-71.6011589, lat=-35.845689, popup="Linares")
...
.pull-right[
- Linares es la comuna con mayor % de votación.

- Retiro, Longaví, y Chanco son las con menor participación.
]